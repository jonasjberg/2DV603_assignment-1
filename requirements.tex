...
%
\subsubsection{Potential guest inquires about future patronage}{
%
% clerk asks about:
%     * stay which nights?
...
\subsubsection{Guest checks in at the hotel}{
% 
% * guest checks in
% 
...
\begin{itemize}\label{scenario1}
  ...
  \item The salesman provides personal information, such as name, for the receptionist who enters
    this into the management system.
    After narrowing down the search results to a single number, the
    receptionist can retrieve the room key and proceed to guide the guest to
    his room.
